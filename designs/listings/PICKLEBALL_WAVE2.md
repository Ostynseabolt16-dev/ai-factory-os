...
**Do tonight:** Upload **Dinking Problem** (`PICKLEBALL_DINKING_PROBLEM.md`) — art ready in `designs/`.  
...
|---|-------|---------------|-----|
| 1 | **YES — next (upload)** | Dinking problem | Hottest search/joke category; type-first like IT WAS IN |
...
**Already covered:** Soft Serve cone (live), Eyes Up Here (live), IT WAS IN (**sold**), Dinking Problem (**art ready**).

---

## Design B — Dinking problem (READY — upload tonight)
...
**eBay price:** **$20.99** S–XL (not $18.99)
...
(small) then six balls in a **3×2** grid, then (tiny)
...
- Beer mug / martini “drinking problem” with ball in glass
- Crossed paddles crest / arched badge
- Letter-as-ball O in DINKING / KITCHEN
- TikTok 3-panel memory comic clone
- Abraham Lincoln portrait + Dinkin’
- JUST DUI IT / Tiger Woods parody
